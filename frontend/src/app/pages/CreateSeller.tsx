  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const sellerData = {
        ...
        avatar: "",
        preferred_agent: null as unknown as number,
      };

      await create(sellerData);
  ...
  return (
    <div className="p-8 min-h-0">
      <div className="mb-6">
        ...
        <p className="text-gray-500 mt-2">Fill in the details to add a new seller</p>
      </div>
