  ...
  return (
    <div className="p-8 min-h-0">
      <div className="mb-6">
        ...
        <h1 className="text-3xl font-bold text-gray-900">Add New Buyer</h1>
        <p className="text-gray-500 mt-2">Fill in the details to add a new buyer</p>
      </div>
